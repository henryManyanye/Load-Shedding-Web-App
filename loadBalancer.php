      	...
      	/********************************************************************/
      			if($userName == "root")
      			{
				    ...
				    /*************************************************/
      				...
      				$result = $mysqli->query("SELECT schedule.location, time FROM schedule LEFT JOIN clients ON schedule.location = clients.location WHERE clients.userName = '$userName' AND clients.password = '$password'");
...
<?php elseif ($letThemThrough == TRUE && $isClient == true): ?>	
	<!DOCTYPE html>
	<html>
		<head>
			<meta charset="utf-8">
		...
		<body>
			...
			<div id="incorrectPassword">				
				<?php $userName[0] = strtoupper($userName[0]); echo"<p>Hello $userName <br><br>This week in $row[0] loadshedding starts from $row[1]</p>"; ?>		
			</div>
		</body>
	</html>
